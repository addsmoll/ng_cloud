...
@Component({
  ...
  styleUrls: ['./search-panels.component.scss'],
  encapsulation: ViewEncapsulation.None
})
export class SearchPanelsComponent  {
  ...
  public thirdControlTexts: IMultiSelectTexts = {
    ...
    checkedPlural: 'items selected',
    searchPlaceholder: 'Find...',
    defaultTitle: 'Выберите площадку',
    allSelected: 'All selected',
  };
  ...
  public isWeekend(date: NgbDateStruct) {
    const d = new Date(date.day, date.month - 1, date.year );
